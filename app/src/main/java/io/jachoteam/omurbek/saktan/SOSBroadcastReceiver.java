...
Приложение экстренного вызова (SOS)
через кнопку блокировки на базе Андроид,
которую можно задействовать в случае чрезвычайной ситуации
и необходим исключительно для личной безопасности граждан
вне зависимости от пола и возрастной категории
